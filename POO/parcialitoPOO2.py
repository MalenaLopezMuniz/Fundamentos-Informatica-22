...
#La Enterprise puede:
    ...
    #La Enterprise "detiene" el ataque con la coraza, y si la coraza no alcanza, 
    #el resto se descuenta de la potencia. Por ejemplo si la Enterprise con 80 de potencia y 12 de coraza recibe un ataque de 20 puntos de fuerza, puede parar solamente 12 con la coraza, los otros 8 se descuentan de la potencia. La nave debe quedar con 72 de potencia y 0 de coraza. Si la Enterprise no tiene nada de coraza al momento de recibir el ataque, entonces todos los puntos de fuerza del ataque se descuentan de la potencia.
"""La potencia y la coraza tienen que mantenerse en los rangos indicados, por ejemplo"""
#si la Enterprise tien 16 puntos de coraza y se encuentra con un escudo, entonces queda en 20 puntos de coraza, no en 26. 
...
"""potencia() coraza() encontrarPilaAtomica() encontrarEscudo() recibirAtaque(puntos)"""
...
#La Enterprise nace con 50 de potencia y 5 de coraza.
	...
	def encontrarPilaAtomica(self):
		if self.pot + 25 <= 100:
			...
			self.pot = 100
    #xq la potencia no puede superar los 100
	...
	def encontrarEscudo(self):
		if self.cor + 10 <= 20:
			...
			self.cor = 20
    #xq la coraza no puede ser mayor a 20
